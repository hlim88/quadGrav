...
D_a ( \alpha D^a \hat{R}) = \alpha \chi \left[\tilde{\gamma}^{ij} \partial_i \partial_j \hat{R} + \tilde{\gamma}^{ij} (\partial_i  \ln \alpha) \partial_j \hat{R} - \tilde{\Gamma}^i \partial_i \hat{R} - \frac{1}{2} \tilde{\gamma}^{ij} \partial_i \hat{R} \partial_j \ln \chi \right]
\end{align}
...
\begin{align}
n^a \nabla_a R &= - \hat{R}  \\
n^a \nabla_a \hat{R} &= -  \chi \left[\tilde{\gamma}^{ij} \partial_i \partial_j \hat{R} + \tilde{\gamma}^{ij} (\partial_i  \ln \alpha) \partial_j \hat{R} - \tilde{\Gamma}^i \partial_i \hat{R} - \frac{1}{2} \tilde{\gamma}^{ij} \partial_i \hat{R} \partial_j \ln \chi \right] \nonumber \\
