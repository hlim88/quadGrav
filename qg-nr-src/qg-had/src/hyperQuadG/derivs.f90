...
!======================================================================! 
     ...
     &                 ) * idx_by_2 
      ...
      !----------------------------------------------------------------
      !
      !   deriv42_y  calculates the first derivative with respect to 
      ...
      !              points, we use a centered second order operator 
      !              rather than an up- or downwind fourth order  
      !              operator.  At the boundary points (j=1,ny) we 
      !              spoil the spirit of this effort of using centered
      !              difference operators and use shifted operators as
      !              appropriate. 
      !
     ...
     &                 ) * idy_by_2 
      ...
      !----------------------------------------------------------------
      !
      !   deriv42_z  calculates the first derivative with respect to 
      ...
      !              points, we use a centered second order operator 
      !              rather than an up- or downwind fourth order  
      !              operator.  At the boundary points (k=1,nz) we 
      !              spoil the spirit of this effort of using centered
      !              difference operators and use shifted operators as
      !              appropriate. 
      !
     ...
     &                  ) * idz_by_2 
      ...
      !                doesnot matter what the sign of beta^x is as 
      ...
      !                order operators irrespective of beta^x s sign.
      !
      !----------------------------------------------------------------      
     ...
     &                   ) * idx_by_12  
      ...
      !                doesnot matter what the sign of beta^y is as 
      !                both signs will require an upwind operator.  
      !                This does seem to violate the spirit of  
      !                using the downwind operator for the case of 
      ...
      !                order operators irrespective of beta^y s sign.
      !
      !----------------------------------------------------------------      
     ...
     &                  ) * idy_by_12  
      ...
      !                doesnot matter what the sign of beta^z is as 
      !                both signs will require an upwind operator.  
      !                This does seem to violate the spirit of  
      !                using the downwind operator for the case of 
      ...
      !                order operators irrespective of beta^z s sign.
      !
      !----------------------------------------------------------------      
...
!     &                   ) * idx_sqrd_by_12
      ...
      !----------------------------------------------------------------
      !
      !  deriv42_yy  calculates the second derivative with respect to  
      !              y using a centered fourth order finite difference 
      !              operator at all points except the boundaries (j=1
      !              and j=ny) and the penultimate boundary points 
      !              (j=2 and j=ny-1).  At the penultimate boundary 
     ...
     &                   ) * idy_sqrd
      ...
      !----------------------------------------------------------------
      !
      !  deriv42_zz  calculates the second derivative with respect to  
      !              z using a centered fourth order finite difference 
      !              operator at all points except the boundaries (k=1
      !              and k=nz) and the penultimate boundary points 
      !              (k=2 and k=nz-1).  At the penultimate boundary 
...
!======================================================================! 
    ...
    !!  Du(i,j,k) = ( a*u(i+3*a,j,k)     &      - 6*a*u(i+2*a,j,k)     &      + 18*a*u(i+a,j,k)     &      - a*u)i,j,k)     &      - 3*a*u(i-a,j,k)     &       
     ...
     &                 ) * idz_by_2 
      ...
      !                sixth order operators irrespective of beta^x
      !                sign.   
      !                 
     ...
     &                 ) * idx_by_60 
      ...
      !                sixth order operators irrespective of beta^y
      !                sign.   
      !                 
     ...
     &                 ) * idy_by_60 
      ...
      !                sixth order operators irrespective of beta^z
      !                sign.   
      !                 
...
!======================================================================! 
     ...
     &                 ) * idz_by_2 
      ...
      !                eighth order operators irrespective of beta^x
      !                sign.  
      !                
     ...
     &                 ) * idx_by_2520 
      ...
      !                eighth order operators irrespective of beta^y
      !                sign.  
      !                
     ...
     &                 ) * idy_by_2520 
      ...
      !                eighth order operators irrespective of beta^z
      !                sign.  
      !                
