     ...
     #ha(2)+t7*adv_d_Alpha(3))
      emEu_rhs_xxx(1) = Betau(1)*adv_d_emEu(1,1)+Betau(2)*adv_d_emEu(2,1
     #)+Betau(3)*adv_d_emEu(3,1)+emEu_rhs(1)
      emEu_rhs_xxx(2) = Betau(1)*adv_d_emEu(1,2)+Betau(2)*adv_d_emEu(2,2
     #)+Betau(3)*adv_d_emEu(3,2)+emEu_rhs(2)
      emEu_rhs_xxx(3) = Betau(1)*adv_d_emEu(1,3)+Betau(2)*adv_d_emEu(2,3
     #)+Betau(3)*adv_d_emEu(3,3)+emEu_rhs(3)
      emBu_rhs_xxx(1) = Betau(1)*adv_d_emBu(1,1)+Betau(2)*adv_d_emBu(2,1
     #)+Betau(3)*adv_d_emBu(3,1)+emBu_rhs(1)
      emBu_rhs_xxx(2) = Betau(1)*adv_d_emBu(1,2)+Betau(2)*adv_d_emBu(2,2
     #)+Betau(3)*adv_d_emBu(3,2)+emBu_rhs(2)
      emBu_rhs_xxx(3) = Betau(1)*adv_d_emBu(1,3)+Betau(2)*adv_d_emBu(2,3
     #)+Betau(3)*adv_d_emBu(3,3)+emBu_rhs(3)
      t1 = Betau(1)
      t4 = Betau(2)
      t7 = Betau(3)
      emPsi_rhs_xxx = t1*adv_d_emPsi(1)+t4*adv_d_emPsi(2)+t7*adv_d_emPsi
     #(3)+emPsi_rhs
      emPhi_rhs_xxx = t1*adv_d_emPhi(1)+t4*adv_d_emPhi(2)+t7*adv_d_emPhi
     #(3)+emPhi_rhs
      t1 = Betau(1)
      t4 = Betau(2)
      t7 = Betau(3)
      phiR_rhs_xxx = t1*adv_d_phiR(1)+t4*adv_d_phiR(2)+t7*adv_d_phiR(3)+
     #phiR_rhs
      phiI_rhs_xxx = t1*adv_d_phiI(1)+t4*adv_d_phiI(2)+t7*adv_d_phiI(3)+
     #phiI_rhs
      piR_rhs_xxx = t1*adv_d_piR(1)+t4*adv_d_piR(2)+t7*adv_d_piR(3)+piR_
     #rhs
      piI_rhs_xxx = t1*adv_d_piI(1)+t4*adv_d_piI(2)+t7*adv_d_piI(3)+piI_
     #rhs
